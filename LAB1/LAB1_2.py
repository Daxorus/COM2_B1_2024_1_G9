...
class LAB1_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "LAB1_2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("LAB1_2")
        ...
        self.Frecuencia = Frecuencia = samp_rate/3
        self.Amplitude = Amplitude = 0

        ##################################################
        # Blocks
        ##################################################
        self._Frequency_range = Range(0, 2000, 100, 0, 200)
        ...
        self._Amplitude_range = Range(0, 1, 0.1, 0, 200)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, Frequency, Amplitude, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_Frecuencia(self.samp_rate/3)
